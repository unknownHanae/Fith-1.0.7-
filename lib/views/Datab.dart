...
// created_at: the time that the item was created. It will be automatically handled by SQLite
  ...
  static Future<int> createItem(
      int idclt, String? mail, String? title, String? descrption, String token, String civilite) async {
    final db = await DatabaseHelper.db();

    final data = {'id': idclt, 'mail': mail, 'title': title, 'description': descrption, 'token': token, 'civilite': civilite};
