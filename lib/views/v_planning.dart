                      ...
                      showDialog(
                        ...
                        builder: (BuildContext context) {
                          ...
                          if (paclient.cin == 'public') {
                            return AlertDialog(
                              content: const Text(
                                  'Vous ne pouvez pas réserver une séance, Veuillez contacter l\'administration pour completer l\'enregistrement !'),
                          ...
                          if (seance.date_reservation == DateFormat("yyyy-MM-dd").format(DateTime.now()) && DateTime.now()
                            ...
                            return AlertDialog(
                              content: Text(
                                  'Vous ne pouvez pas réserver une séance, Veuillez contacter l\'administration pour réactiver votre compte'),
                              shape: RoundedRectangleBorder(
                                borderRadius: BorderRadius.circular(16.0),
                              ),
                            );
                              ...
                              seance.genre != 'Mixte') {
                            return AlertDialog(
                              content: Text('Cette séance est destinée aux femmes!'),
                              shape: RoundedRectangleBorder(
                                borderRadius: BorderRadius.circular(16.0),
                              ),
                            );
                              ...
                              seance.genre != 'Mixte') {
                            return AlertDialog(
                              content: Text('Cette séance est destinée aux hommes!'),
                              shape: RoundedRectangleBorder(
                                borderRadius: BorderRadius.circular(16.0),
                              ),
                            );
                            ...
                            return AlertDialog(
                              content: Text('la séance est pleine'),
                              shape: RoundedRectangleBorder(
                                borderRadius: BorderRadius.circular(16.0),
                              ),
                            );
                            ...
                            return AlertDialog(
                              content: Text('Vous avez déjà réservé cette séance'),
                              shape: RoundedRectangleBorder(
                                borderRadius: BorderRadius.circular(16.0),
                              ),
                            );
                            ...
                            return AlertDialog(
                              content: Text(
                                  'Vous avez déjà réservé deux séances ce jour'),
                              shape: RoundedRectangleBorder(
                                borderRadius: BorderRadius.circular(16.0),
                              ),
                            );
                            ...
                            return Center(
                              child: AlertDialog(
                                ...
                                actions: [
                                  TextButton(
                                    child: const Text('Réserver',style: TextStyle(color: Colors.orange,fontSize:13),),
                                    onPressed: () async {
                                      // Timer? _timer;
                                      // @override
                                      // void initState() {
